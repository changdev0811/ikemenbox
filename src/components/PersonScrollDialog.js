...
class PersonScrollDialog extends React.Component {
  state = {
    open: false,
    scroll: 'paper',
  };
  ...
  render() {
    return (
      <div>
        ...
        <Button onClick={this.handleClickOpen('body')}>小澤廉</Button>
        <Dialog
        ...
        >
          <DialogTitle id="scroll-dialog-title">小澤廉</DialogTitle>
          <DialogContent>
            <PersonCarousel/>
            <DialogContentText>
...
export default PersonScrollDialog;
